...
import { Loader2, ArrowRight, Lock, ArrowLeft, CheckCircle } from 'lucide-react'
...
const ERROR_MESSAGES: Record<string, string> = {
    ...
    no_clinic: 'Your account is not assigned to a clinic. Contact admin.',
}
...
function LoginForm() {
    ...
    // Clear stale session cookie when redirected here with an error
    useEffect(() => {
        if (errorCode) {
